        ...
        for (int i = 0; i < numeroOperacoes; i++) {
            ...
            try {
                if (comando.startsWith("II ")) {
                    int id = Integer.parseInt(trimManual(comando.substring(3)));
                    Game jogo = buscarPorId(todosJogos, id);
                    if (jogo != null) {
                    ...
                    int pos = Integer.parseInt(trimManual(partes[0]));
                    int id = Integer.parseInt(trimManual(partes[1]));
                    Game jogo = buscarPorId(todosJogos, id);
                    if (jogo != null) {
                        lista.inserir(jogo, pos);
                    }
                    ...
                    int pos = Integer.parseInt(trimManual(comando.substring(3)));
